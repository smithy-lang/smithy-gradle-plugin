...
spotless {
    ...
    kotlinGradle {
        ...
        endWithNewline()
        // "description" is included alongside the reference repo's delimiters because several
        // of this project's subproject scripts open with a `description = ...` assignment.
        licenseHeaderFile(
            "${project.rootDir}/config/spotless/license-header.txt",
            "import|tasks|apply|plugins|rootProject|description"
        )
    }
    tasks {
